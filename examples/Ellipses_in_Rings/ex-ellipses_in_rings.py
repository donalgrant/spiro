...
for a in np.linspace(9,25,2):
    ...
    for i in range(6):
        w.po=pi/24*i
        S.add(ellipse_in_circle(Ring(30),w,loops=5,inside=True,ppl=3000))
...
for a in np.linspace(5,20,5):
    w = Ellipse(a,0.7,1.3*a)
    for i in range(3):
        S.add(ellipse_in_circle(Ring(30-i*2),w,loops=3,inside=True,ppl=3000))
...
for a in np.linspace(5,20,5):
    w = Ellipse(a,0.7,1.3*a)
    S.add(ellipse_in_circle(Ring(30),w,loops=8,inside=True,ppl=3000))
...
r = Ring(20)
S.add(ellipse_in_circle(r,Ellipse(0.01,0.0,0.0),loops=1,inside=True))
S.add(ellipse_in_circle(r,Ellipse(5.2,0.8,3),loops=10,inside=False,ppl=3000))
S.add(ellipse_in_circle(r,Ellipse(5.2,0.8,3,S.pc()),loops=10,inside=True,ppl=3000))
...
S.add(ellipse_in_circle(r,Ellipse(3,0.1,4,0),loops=21, inside=False, ppl=2000))
