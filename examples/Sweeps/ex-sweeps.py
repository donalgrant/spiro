...
for i in range(36):
    ...
    S.add(elliptical_in_ellipse(wheel=w,inside=True,loops=.3))
    S.rotate(pi/128*i)
    S.x+=1
    S.y-=1
...
for i in range(100):
    T.reset()
    r=Ellipse(20,0.5,0,0)
    T.add(elliptical_in_ellipse(wheel=w,inside=True,loops=.8))
    T.rotate(pi/128*i)
    S.add(T)
    S.x+=0.5
    S.y-=1
...
for i in range(40):
    ...
    r=Ellipse(20,0.5,0,0)
    T.add(elliptical_in_ellipse(wheel=w,inside=True,loops=.65))
    S.add(T)
...
for i in range(40):
    ...
    w=Ellipse(9,0.4,13,pi/80*i,pi/4)
    r=Ellipse(20,0.7,0,0)
    T.add(elliptical_in_ellipse(wheel=w,inside=True,loops=.55))
    T.rotate(pi/128*i)
    S.add(T)
...
for i in range(30):
    ...
    r=Ellipse(20,0.7,0,0)
    T.add(elliptical_in_ellipse(wheel=w,inside=False,loops=.55))
    T.rotate(pi/128*i)
    S.add(T)
    S.x+=0.5
    S.y+=0.5  
...
for i in range(30):
    ...
    T.add(elliptical_in_ellipse(ring=r,wheel=w,inside=True,loops=.75))
    T.rotate(pi/128*i)
    S.add(T)
    S.x+=0.5
    S.y+=0.5   
...
for i in range(30):
    ...
    w=Ellipse(9,0.4,13+i/5,pi/80*i,0)
    r=Ellipse(20+i/6,0.6,pi/2,0)
    T.add(elliptical_in_ellipse(ring=r,wheel=w,inside=True,loops=1.5))
    T.rotate(-pi/64*i)
    S.add(T)
    S.x+=0.5
...
for i in range(30):
    ...
    r=Ellipse(20+i/6,0.6,pi/2,0)
    T.add(elliptical_in_ellipse(ring=r,wheel=w,inside=True,loops=1.3))
    T.rotate(-pi/64*i)
    S.add(T)
...
for i in range(30):
    ...
    T.add(elliptical_in_ellipse(ring=r,wheel=w,inside=True,loops=0.75))
...
for i in range(70):
    ...
    T.add(elliptical_in_ellipse(ring=r,wheel=w,inside=True,loops=0.45))
    T.rotate(3*pi/2-pi/45*i)
    S.add(T)
    S.x-=0.5
