...
F.plot(spiro_steps(10.0,Wheel(3,1),1.0,40,7),color_scheme='v-waves',new_fig=False,caption=False)
F.plot(spiro(10.0,Wheel(9,4),40),   color_scheme='h-waves',new_fig=False,caption=False)
F.plot(spiro(10.0,Wheel(9,1.1),40), color_scheme='ripples',new_fig=False)
F.save_fig()
...
for i in range(10):
    S.add(spiro(2.0,Wheel(a,bv[i]),9))
