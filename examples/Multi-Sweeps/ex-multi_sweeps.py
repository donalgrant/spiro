...
for wo in linspace(0,5*pi,3):
    for i in range(30):
        ...
        T.add(elliptical_in_ellipse(ring=r,wheel=w,inside=True,loops=0.5))
        S.add(T)
...
for wo in linspace(0,3*pi,5):
    for i in range(12):
        ...
        r=Ellipse(major=20, eccen=0.7,       offset=0, pen_offset=wo)
        T.add(elliptical_in_ellipse(ring=r,wheel=w,inside=True,loops=0.3))
        T.rotate(wo)
        T.x+=i
        S.add(T) 
...
for sweep in range(15):
    ...
    for i in range(20):
        ...
        T.add(elliptical_in_ellipse(ring=r,wheel=w,inside=True,loops=0.06))
 #       T.rotate(wo)
 #       T.x+=i
        S.add(T)
...
for sweep in range(15):
    ...
    for i in range(20):
        ...
        w=Ellipse(major=3,  eccen=0.4,pen=4, offset=i*pi/20, pen_offset=0)
        r=Ellipse(major=R, eccen=0.0,       offset=0, pen_offset=wo)
        T.add(elliptical_in_ellipse(ring=r,wheel=w,inside=True,loops=0.1))
...
for sweep in range(15):
    ...
    for i in range(10):
        ...
        w=Ellipse(major=3,  eccen=0.4,pen=4, offset=i*pi/20, pen_offset=0)
        r=Ellipse(major=R, eccen=0.0,       offset=0, pen_offset=wo)
        T.add(elliptical_in_ellipse(ring=r,wheel=w,inside=False,loops=0.1))
    T.x+=np.random.uniform(-R,R)
    T.y+=np.random.uniform(-R,R)
    S.add(T)
...
for sweep in range(15):
    ...
    for i in range(10):
        ...
        T.add(elliptical_in_ellipse(ring=r,wheel=w,inside=True,loops=0.2))
        T.rotate(i/280)
    T.x+=np.random.uniform(-R,R)
    T.y+=np.random.uniform(-R,R)
    S.add(T)
