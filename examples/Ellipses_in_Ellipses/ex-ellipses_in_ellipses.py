...
for i in range(nc):
    S.add(ellipse_in_ellipse(Ellipse(30,0.7,0,pi/4),
...
for i in range(nc):
    S.add(ellipse_in_ellipse(Ellipse(30,0.7,0,pi/2),
...
for i in range(nc):
    S.add(ellipse_in_ellipse(Ellipse(10,0.6,0,pi/2),
...
bv=[0.8*a-0.005*a*i for i in range(nc)]
for i in range(nc):
    S.add(ellipse_in_ellipse(Ellipse(11,0.6,0,pi/4,i*pi/30),
...
a=9.0
for i in range(10):
    S.add(ellipse_in_ellipse(Ellipse(11.5,0.6,0,pi/4,i*pi/30),
...
a=9.0
for i in range(10):
    S.add(ellipse_in_ellipse(Ellipse(11.5+i/40,0.6,0,pi/4,i*pi/50),
                             Ellipse(a,0.5,0.8*a-0.05*a*i),5,inside=True))
...
a=9.0
for i in range(10):
    S.add(ellipse_in_ellipse(Ellipse(12+i*0,0.6,0,pi/3,i*pi/50),
...
a=11.0
for i in range(10):
    S.add(ellipse_in_ellipse(Ellipse(9+i*0,0.3,0,pi/3,i*pi/50),
